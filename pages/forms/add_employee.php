  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
        ...
        <div style="width:90%; display: block; margin-left: auto; margin-right: auto;" class="row">
          ...
          <div class="row">
            ...
            <!-- MY FORM -->
            <div  style="width:90%; display: block; margin-left: auto; margin-right: auto;" class="col-12 grid-margin stretch-card">
              <div class="card">
                <div  class="card-body">
