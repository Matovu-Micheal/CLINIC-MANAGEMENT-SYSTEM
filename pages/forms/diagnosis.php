          ...
          <div style="width:90%;" class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div style="margin-left:2em" class="diagnosis_form mt-5 mb-5" >
                <!-- <div class=""  onclick="toggle('diagnosis_form');"> -->
                <div class="">
                  <h4 style="width:15em;" class="btn btn-primary">FILL DIAGNOSIS FORM</h4>
                  <div class="mb-4"><a>Enter patient's diagnosis.</a></div>
                </div>
